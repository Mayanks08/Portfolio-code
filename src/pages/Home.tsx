    ...
    <div className="min-h-[calc(100vh-200px )]  ml-10 flex flex-col justify-center">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="order-2 lg:order-1">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 bg-gradient-to-r from-white to-purple-400 bg-clip-text text-transparent animate-pulse">
            Mayank Saini
          </h1>
        ...
        <div className="order-1 lg:order-2 flex justify-center">
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-purple-500 shadow-xl shadow-purple-900/30 transition-all duration-500 hover:shadow-white hover:scale-105">
            <img 
              src="https://avatars.githubusercontent.com/u/95845450?v=4" 
              alt="Mayank Saini" 
      ...
      <div className="mt-20">
        ...
        <div className="flex  flex-wrap justify-center gap-4">
          {['HTML', 'CSS', 'JavaScript', 'React', 'Node.js', 'Express', 'MongoDB', 'Redux', 'Tailwind CSS', 'Git', 'AWS', 'Python','AI','GenAI','Vite'].map((tech) => (
            <span 
              key={tech} 
